...
namespace Discuz.Install
{
    public class InstallUtils
    {
        ...
        public static void SaveDntConfigForumPath()
        {
            ...
            string forumPath = request.Url.ToString().Replace("http://" + request.Url.Authority, "");//获取当前的路径 主要是为了获取 安装目录
            ...
            forumPath = forumPath.Substring(0, forumPath.IndexOf("install"));//获取根目录
            BaseConfigInfo baseConfig = BaseConfigs.GetBaseConfig();//获取配置文件信息
