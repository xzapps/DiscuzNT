...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2013/11/19 13:53:13.
		本页面代码由Discuz!NT模板引擎生成于 2013/11/19 13:53:13. 
	*/
	...
	templateBuilder.Append("\" class=\"lightlink\">" + announcement["poster"].ToString().Trim() + "</a> 发表于: <span\r\n                        class=\"time\">\r\n                        ");	templateBuilder.Append(TypeConverter.StrToDateTime(announcement["starttime"].ToString().Trim()).ToString(" yyyy-MM-dd HH:mm"));
	templateBuilder.Append("</span> 结束于:<span class=\"time\">");	templateBuilder.Append(TypeConverter.StrToDateTime(announcement["endtime"].ToString().Trim()).ToString(" yyyy-MM-dd HH:mm"));
