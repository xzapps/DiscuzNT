...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	int topicEx__loop__id=0;
	foreach(TopicInfo topicEx in topiclist)
	{
		topicEx__loop__id++;
	...
	else
	{
	 ...
	 aspxrewriteurl = Urls.ShowTopicAspxRewrite(topicEx.Tid,0, DNTRequest.GetInt("typeid", -1));
	

	if (topicEx.Special==4)
	{

	 aspxrewriteurl = Urls.ShowDebateAspxRewrite(topicEx.Tid, DNTRequest.GetInt("typeid", -1));
	

	}	//end if

	int ishtmltitle = Topics.GetMagicValue(topicEx.Magic, MagicType.HtmlTitle);
	...
	templateBuilder.Append("\" >\r\n                                    ");
	templateBuilder.Append(Topics.GetHtmlTitle(topicEx.Tid).ToString().Trim());
	templateBuilder.Append("</a>\r\n                                ");
	}
	else
	{
	...
	templateBuilder.Append("\" >\r\n                                    ");
	templateBuilder.Append(topicEx.Title.ToString().Trim());
	templateBuilder.Append("</a>\r\n                                    ");
	}
	else
	{
	...
	templateBuilder.Append(post.Pid.ToString().Trim());
	templateBuilder.Append("\" cellspacing=\"0\" cellpadding=\"0\" style=\" border-bottom:1px dotted #ccc;\">\r\n		<tbody>\r\n	<tr>\r\n		\r\n		<td class=\"postcontent\">\r\n			<div class=\"pi\">\r\n				<div class=\"postinfo\"> \r\n                <strong>\r\n					<a href=\"###\" class=\"floor\" title=\"复制帖子链接到剪贴板\" onclick=\"copypostlayer(");
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append(",");
	templateBuilder.Append(post.Pid.ToString().Trim());
	templateBuilder.Append(",'");
	...
	templateBuilder.Append("<sup>楼</sup>\r\n					");
	}	//end if
	...
	templateBuilder.Append("\r\n						<a href=\"modcp.aspx?operation=edituser&op=edit&uid=");
	templateBuilder.Append(post.Posterid.ToString().Trim());
	templateBuilder.Append("\" target=\"_blank\">编辑该用户</a>\r\n						");
	}	//end if
	...
	templateBuilder.Append("<div id=\"tpn\"><ul class=\"prenext\"><li class=\"pre\"><a href=\"showtopic.aspx?forumid=");
	templateBuilder.Append(forumid.ToString());
	templateBuilder.Append("&forumpage=");
	templateBuilder.Append(forumpageid.ToString());
	templateBuilder.Append("&topicid=");
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append("&go=next\">上一主题</a></li>\r\n		<li class=\"next\"><a href=\"showtopic.aspx?forumid=");
	templateBuilder.Append(forumid.ToString());
	templateBuilder.Append("&forumpage=");
	templateBuilder.Append(forumpageid.ToString());
	templateBuilder.Append("&topicid=");
	templateBuilder.Append(topicid.ToString());
	templateBuilder.Append("&go=prev\">下一主题</a></li></ul></div>\r\n		");
	}	//end if
