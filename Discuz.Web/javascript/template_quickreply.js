...
function saveResult(doc, imagedir, redirect) {
    ...
    var html = '';
    html += '		<table cellpadding="0" cellspacing="0" border="0" id="' + pid + '" name="' + pid + '"  style=" border-bottom:1px dotted #ccc;" >';
    html += '			<tbody>';
    html += '			<tr>';
    ...
    html += '您  发表于 <em>   ' + postdatetime + '</em>	';

    html += ' </div>';
    html += ' </div>';
    html += ' <div id="ad_thread2_' + id + '"></div>';
    html += ' <div id="ad_thread3_' + id + '"></div>';
    html += ' <div class="postmessage defaultpost" style="min-height: 1px !important;">';
